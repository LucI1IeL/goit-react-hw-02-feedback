  ...
  return (
    <div className={css.divStatistics}>
      <p className={css.labelStat}>
        <RiEmotionHappyFill className={`${css.icons} ${css.happy}`}/> Good:
        <span className={css.value}> {good}</span>
      </p>
      <p className={css.labelStat}>
        <MdOutlineSentimentNeutral className={`${css.icons} ${css.neutral}`}/> Neutral:
        <span className={css.value}> {neutral}</span>
      </p>
      <p className={css.labelStat}>
        <FaSadTear  className={`${css.icons} ${css.sad}`}/> Bad:
